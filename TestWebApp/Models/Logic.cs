...
namespace TestWebApp.Models
{
    public class Logic
    {
        ...
        private Game ConnectExistGame(int userid, Game game){
        ...
        public GameInfo InitGameInfo(Game game ,Side side)
        {
        ...
        private Game CreateNewGame(int userid)
        {
            Game game = new Game();
        ...
        public Side GetSide(int userid)
        {
            Side side = db
                .Sides
                .Where(g=>g.PlayerID == userid)
        ...
        internal Game MakeMove(int id,int userid,string move){
        ...
        public bool RestartOrNewGame(int userid){
            Player player = db.Players.Find(userid);
            if(player != null)
            {
